...
async function runTimesheetTasksMigration() {
  ...
  try {
    const sql = fs.readFileSync(path.join(__dirname, 'migrations', 'create-timesheet-tasks-table.sql'), 'utf8');
